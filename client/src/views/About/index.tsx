			...
			<Hero.Content className="">
				<div className="max-w-lg">
					...
					<p className="py-10">
						...
						deleniti eaque aut repudiandae et a id nisi. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius
						inventore, et, at nobis dolorem laborum fugit voluptas enim consequatur dicta voluptatum aut? Sequi nihil
						pariatur dolore voluptatum exercitationem facere reprehenderit.
					</p>
				</div>
			</Hero.Content>
		</Hero>
